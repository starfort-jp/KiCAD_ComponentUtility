...
uses
  ...
  Buttons, ExtCtrls, Grids, RichMemo, lazutf8, Unit2, Unit3, Unit5, memds, CSVDocument;//DefaultTranslator, LCLTranslator;
type
  { TForm1 }
...
resourcestring
  Caption11 = 'Only available for *Single* component in schematic libraries file.';
  Caption12 = 'Nothing to save.';
...
//Save to file
  ...
  begin
    Form5.Label1.Caption := Caption12;
    Form5.Show;
  end;
end;
...
//Fill Form3 StringGrid
  ...
  begin
    ...
    Form3.Show;
    Form3.StringGrid2.AutoSizeColumns;
    Form3.StringGrid2.Update;
    Form3.StringGrid2.Clear;
    Form3.StringGrid2.RowCount := xMaxRow + 1;
    ...
    begin
      ...
      Form3.StringGrid2.Cells[1, m] := StringGrid1.Cells[3, xStart + 1 + n];
      Form3.StringGrid2.Cells[2, m] := StringGrid1.Cells[4, xStart + 1 + n];
      Form3.StringGrid2.Cells[3, m] := StringGrid1.Cells[5, xStart + 1 + n];
      Form3.StringGrid2.Cells[4, m] := StringGrid1.Cells[6, xStart + 1 + n];
    end;
//Draw Graphic
//---Body
    Form3.xPins := xMaxRow;
...
//---Pin
  ...
  begin
    StringGrid1.Clear;  // Reset the grid:
    StringGrid1.Visible := False;
    Form5.Label1.Caption := Caption11;
    Form5.Show;
  end;
//---
end;
